...
const envSchema = z.object({
  ...
  // ThinkLink API
  THINKLINK_LOGIN: z.string().optional(),
  THINKLINK_TOKEN: z.string().optional(),
  THINKLINK_API_BASE: z.string().url().default('https://thinklink.ru/api'),
...
export const env: AppEnv = envSchema.parse({
  ...
  THINKLINK_LOGIN: process.env.THINKLINK_LOGIN,
  THINKLINK_TOKEN: process.env.THINKLINK_TOKEN,
  THINKLINK_API_BASE: process.env.THINKLINK_API_BASE,
